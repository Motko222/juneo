...
status_val=$(curl -sX POST --data '{ "jsonrpc": "2.0", "method": "platform.getCurrentValidators", "params": { "nodeIDs": ["$node_id"] }, "id": 1 }' -H 'content-type:application/json;' $host:9650/ext/bc/P )
